...
=============================================================================
【文件说明】
  train.py          本文件 — 单模型训练脚本，通过 MODEL_TYPE 变量切换架构
  sever.py          WebSocket 推理服务器 — 加载训练好的权重，向前端推送预测结果
...
【自定义亮点】
  ...
  6. 对比分析配套 — 配合 compare_models.py 可自动生成训练效率/收敛特性/成本性能评估图表
=============================================================================
"""
import torch
...
# 可选值: 'RNN' | 'GRU' | 'LSTM'
# ==========================================
MODEL_TYPE = 'RNN'  # 修改此处切换模型类型，保持与 sever.py 一致
